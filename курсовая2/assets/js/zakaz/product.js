      ...
      if (cart.length === 0) {
          ...
          cart.forEach(item => {
              ...
              cartItemElement.innerHTML = `
                  <div class="cart-item-image" style="width: 60px; height: 60px; background-image: ${item.image}; background-size: cover; background-position: center; border-radius: 8px;"></div>
                  <div class="cart-item-info" style="flex: 1; padding: 0 15px;">
                      <div class="cart-item-name" style="font-weight: bold; margin-bottom: 5px;">${item.name}</div>
                      <div class="cart-item-weight" style="font-size: 12px; color: #666; margin-bottom: 5px;">${item.weight}</div>
                      <div class="cart-item-price" style="color: #f85f73; font-weight: bold;">${(item.price * item.quantity).toFixed(2)} ₽</div>
                  </div>
                  <div class="cart-item-quantity" style="display: flex; align-items: center; gap: 10px;">
                      <button class="quantity-btn minus" data-id="${item.id}" style="background: #f85f73; color: white; border: none; width: 25px; height: 25px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;">-</button>
                      <span style="min-width: 20px; text-align: center;">${item.quantity}</span>
                      <button class="quantity-btn plus" data-id="${item.id}" style="background: #f85f73; color: white; border: none; width: 25px; height: 25px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;">+</button>
                  </div>
              `;
